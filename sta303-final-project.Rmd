...
```
```{r, fig.height=10, message=FALSE, warning=FALSE, echo=FALSE}
# Move to a new page
library("gridExtra")
library(grid)
grid.newpage()
...
# #   )
# plot_grid(inc, age, sleep, ncol=2, rel_heights = c(1,2), rel_widths = c(1,1,0.1,0.9))
```
