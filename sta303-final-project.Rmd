...
inc <- cust_dev_info %>%
  ...
  xlab("Median Income (in Canadian dollars)") +
    labs(caption = "Boxplots displaying incomes of customers who purchased MINGAR's new affordable line \n vs. customers who purchased MINGAR's other lines (i.e. 'Traditional Customers').") +
  theme_minimal() +
